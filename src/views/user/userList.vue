          ...
          <div style="width:80%;margin: 0 auto">
            <el-form :model="ruleForm" status-icon :rules="rules"  ref="ruleForm" :inline="false" label-width="90px" class="demo-ruleForm">
                ...
                <el-form-item label="密码"   prop="password">
                  <el-input type="text" placeholder="密码" auto-complete="off" v-model="ruleForm.password"></el-input>
                </el-form-item>
...
<script>
import { getUserList,addUser,updateUser,deleteUser,getRoleList,upload,changeUserPw} from '@/api/user'
